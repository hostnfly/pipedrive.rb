...
## [v0.6.0](https://github.com/hostnfly/pipedrive.rb/compare/v0.5.0...v0.6.0) - 2026-06-26

### Added
- `Pipedrive::APIError` — base error class with `status` and `code` attributes
- `Pipedrive::BadRequestError`, `NotFoundError`, `UnauthorizedError`, `ForbiddenError` — typed errors raised on 400/404/401/403 responses
